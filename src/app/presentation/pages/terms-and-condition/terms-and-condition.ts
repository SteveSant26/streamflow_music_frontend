    ...
    this.sections = [
      {
        ...
        color: 'blue',
        content:
          'Al acceder y utilizar StreamFlow Music, usted acepta cumplir con estos Términos y Condiciones de Servicio. Si no está de acuerdo con alguno de estos términos, no debe utilizar nuestro servicio.',
        highlights: [
      ...
      },
      {
        ...
        color: 'green',
        content:
          'StreamFlow Music es una plataforma de streaming de música que ofrece acceso a millones de canciones, álbumes y playlists. Proporcionamos diferentes niveles de servicio según el plan de suscripción.',
      },
      {
        id: 'accounts',
        ...
        color: 'purple',
        content:
          'Para utilizar ciertas funciones de StreamFlow Music, debe crear una cuenta. Usted es responsable de mantener la confidencialidad de su cuenta y contraseña.',
        warning: [
      ...
      },
      {
        ...
        color: 'orange',
        content:
          'Usted se compromete a utilizar StreamFlow Music de manera responsable y de acuerdo con las leyes aplicables.',
        warning: [
      ...
      },
      {
        ...
        color: 'indigo',
        content:
          'Todo el contenido disponible en StreamFlow Music está protegido por derechos de autor y otras leyes de propiedad intelectual. Los usuarios tienen una licencia limitada para el uso personal.',
      },
      {
        id: 'privacy',
        ...
        color: 'teal',
        content:
          'Su privacidad es importante para nosotros. Consulte nuestra Política de Privacidad para obtener información sobre cómo recopilamos, utilizamos y protegemos sus datos.',
      },
      {
        id: 'modifications',
      ...
      },
      {
        ...
        color: 'blue',
        content:
          'Si tiene preguntas sobre estos Términos y Condiciones, puede contactarnos a través de los siguientes medios.',
      },
    ];
  }
