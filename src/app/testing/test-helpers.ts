 ...
 */
export function getElements<T>(fixture: ComponentFixture<T>, selector: string): HTMLElement[] {
 ...
 */
export function isVisible<T>(fixture: ComponentFixture<T>, selector: string): boolean {
  const element = getElement(fixture, selector);
